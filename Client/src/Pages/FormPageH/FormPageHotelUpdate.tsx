...
const formValidationSchema = yup.object().shape({
  name: yup.string().trim().min(2, "Minimo 2 caracteres"),

  description: yup.string().trim().min(10, "Minimo 10 caracteres"),
  ...
  const handleSubmit = useCallback(
    async (values: FormValues, helpers: FormikHelpers<FormValues>) => {
      try {
        ...
        const countryToBack = values.country
          ? values.country
          : currentHotelData?.country;
        const cityToBack = values.city ? values.city : currentHotelData?.city;
        const photoToBack = values.photo
          ? values.photo
          : currentHotelData?.photo;
        const hotelCategoryToBack = values.category
          ? values.category
          : currentHotelData?.hotelCategory;
        const servicesToBack = values.services
          ? values.services
        ...
        <div className="max-h-full">
          ...
          <Formik<FormValues>
            ...
            initialValues={{
              ...
              country: "",
              city: "",
              photo: currentHotelData?.photo || [Hotel],
              category: "",
              services: [],
            }}
            ...
            {({ values, errors, setFieldValue, resetForm }) => {
              ...
              return (
                <Form>
                  ...
                  <FormControl
                    validation={
                      errors.services && !areServicesSelected
                        ? "invalid"
                        : "valid"
                    }
                    className="mb-4"
